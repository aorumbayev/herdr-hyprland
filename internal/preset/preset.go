...
// removes a prefix+* default. resize_pane_* ship unset in herdr, so they
// carry no default entry.
var nativeKeys = []key{
	{"focus_pane_left", []string{"prefix+h", "alt+left", "alt+h"}},
	{"focus_pane_down", []string{"prefix+j", "alt+down", "alt+j"}},
	{"focus_pane_up", []string{"prefix+k", "alt+up", "alt+k"}},
	{"focus_pane_right", []string{"prefix+l", "alt+right", "alt+l"}},
	{"swap_pane_left", []string{"prefix+shift+h", "alt+shift+left", "alt+shift+h"}},
	{"swap_pane_down", []string{"prefix+shift+j", "alt+shift+down", "alt+shift+j"}},
	{"swap_pane_up", []string{"prefix+shift+k", "alt+shift+up", "alt+shift+k"}},
	{"swap_pane_right", []string{"prefix+shift+l", "alt+shift+right", "alt+shift+l"}},
	{"resize_pane_left", []string{"alt+ctrl+left"}},
	{"resize_pane_down", []string{"alt+ctrl+down"}},
	{"resize_pane_up", []string{"alt+ctrl+up"}},
	{"resize_pane_right", []string{"alt+ctrl+right"}},
	{"switch_tab", []string{"prefix+1..9", "alt+1..9"}},
	{"next_tab", []string{"prefix+n", "alt+n"}},
	{"previous_tab", []string{"prefix+p", "alt+p"}},
	{"zoom", []string{"prefix+z", "alt+z"}},
	{"close_pane", []string{"prefix+x", "alt+w"}},
}
...
func appendCommands(config string) string {
	...
	b.WriteString("[[keys.command]]\n")
	b.WriteString(`key = "alt+ctrl+tab"` + "\n")
	b.WriteString(`type = "plugin_action"` + "\n")
	b.WriteString(`command = "herdr-hyprland.last-tab"` + "\n")
	b.WriteString(`description = "focus the previously focused tab"` + "\n")
	return b.String()
}
